...
import "./DownloadsBlock.css";
import { Button } from "../Button";

export const DownloadsBlock = () => (
  <div className="top-selection__downloads">
    <Button className="top-selection__button_android">
      <svg className="button-icon" viewBox="0 0 135 40">
        <path
        ...
        <path
          ...
          fill="url(#paint0_linear_32462_334)"
        />
        <path
    ...
    <Button className="top-selection__button_apple">
